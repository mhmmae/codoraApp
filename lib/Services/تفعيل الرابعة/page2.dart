import 'dart:typed_data'; // للتفاعل مع الصورة لاحقاً (إذا احتجت)
import 'package:codora/Services/%D8%AA%D9%81%D8%B9%D9%8A%D9%84%20%D8%A7%D9%84%D8%B1%D8%A7%D8%A8%D8%B9%D8%A9/page2WIDGET.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart'; // للـ SelectableText
...
class BarcodeResultPage extends StatelessWidget {
  ...
  BarcodeResultPage({Key? key, required this.barcode}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Obx(() {
          ...
          if (pricingController.price.value != null && pricingController.price.value > 0) {
