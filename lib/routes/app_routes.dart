class AppRoutes {
  ...
  static const String DRIVER_DELIVERY_NAVIGATION = '/driver-delivery-navigation/:taskId';
  ...
  // New routes
  static const String TASKS_NEEDING_INTERVENTION = '/tasks-needing-intervention';
  ...
  static const String COMPANY_TASKS_PENDING_DRIVER = '/company-tasks-pending-driver';
} 