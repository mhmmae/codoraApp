      ...
      builder: (logic) {
        return logic.videoUrl != null
          ...
          children: [
            ...
            logic.uploadProgress != null
                ? Positioned(
              bottom: 20,
              right: 20,
              child: Text(
                'تحميل: ${logic.uploadProgress!.toStringAsFixed(0)}%',
                style: TextStyle(
                    color: Colors.white, fontSize: wi / 20),
              ),
            )
                : Container(),
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration:  BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(ImageX.ImageAddVodioItem),
                ),
              ),
            ),
          ),
