...
class LocationPickerScreen1 extends StatefulWidget {
  final LatLng? initialLocation;
  final double? initialAccuracy; // دقة الموقع الأولي (إذا كان من GPS)

  const LocationPickerScreen1({super.key, this.initialLocation, this.initialAccuracy});

  @override
  State<LocationPickerScreen1> createState() => _LocationPickerScreenState();
}

class _LocationPickerScreenState extends State<LocationPickerScreen1> {
